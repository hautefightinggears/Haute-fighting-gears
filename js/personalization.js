...
const HFG_P = (function () {
  ...
  const _upsellMap = {
    ...
    'mma': ['inner-gloves', 'quick-hand-wrap'],
    ...
    'quick-hand-wrap': ['inner-gloves', 'boxing-gloves'],
    'inner-gloves': ['boxing-gloves', 'quick-hand-wrap']
  };
  ...
  function renderRecentlyViewed(containerEl, allProducts, pagePrefix) {
    ...
    const html = `
      ...
      return `<a href="${pagePrefix}?id=${encodeURIComponent(p.id)}"
